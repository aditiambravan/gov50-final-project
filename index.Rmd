...
It is important to note that a multiple regression cannot be visualized in a 2D format. Additionally, in each of the above regression scenarios that are statistically significant, I do not believe that the relationship can be interpreted causally due to the presence of numerous confounding variables that influence politicla freedom. 
